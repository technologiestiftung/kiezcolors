...
<p id="intro-text" class="flex mt-4 flex-wrap justify-evenly">
	Move the map of Berlin to create a postcard showing the landuse distribution in your neighborhood.
</p>
<section class="flex m-4 mt-0 flex-wrap justify-evenly">
	<span class=" m-2"><span class="text-center w-full inline-block my-4">Map</span><Map /></span>
	<span class="m-2"
		><span class="text-center w-full inline-block my-4">Postcard front</span><Tree /></span
	>
	<span class=" m-2"
		><span class="text-center w-full inline-block my-4">Postcard back</span><Text /></span
	>
